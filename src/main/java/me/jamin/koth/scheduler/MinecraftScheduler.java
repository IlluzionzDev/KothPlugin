...
/**
 * THIS IS A SCHEDULER I ALREADY WROTE
 *
...
public abstract class MinecraftScheduler {
                ...
                if ((type.equals(Sync.class) && element.timer.isReady())
                    ...
                    if (element.object instanceof Method) {
                        ...
                        try {
                            ...
                            throw new RuntimeException("Interrupted synchronization invocation: in " + service.source.getClass());
                        }
                    }
                }
            }
    ...
    public boolean safelyTick(Tickable tickable) {
        try {
            ...
            throw new RuntimeException("Interrupted tick call!:");
        }
